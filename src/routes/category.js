...
router.put('/admin/categories/:slug', verifyToken, categories.updateCategoryBySlug);
router.delete('/admin/categories/:slug', verifyToken, categories.deleteCategoryBySlug);
